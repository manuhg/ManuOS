...
#define structconv(ptrtype,struct_) (*(ptrtype *)(&struct_))//value of a struct can be obtained
#define vartostruct(var,structtype) ((structtype) *((structtype *)(&(var))))//variable can be assigned to a struct

#define low_byte(n) (n & 0x00ff)
#define high_byte(n) ((n>>16)&0x00ff) //previously n>>8
